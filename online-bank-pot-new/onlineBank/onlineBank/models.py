...
class innerTemplate(models.Model):
    name = models.CharField(max_length=50, default='template.html', primary_key=True)
...
class MySite(Site):
    ...
    template = models.ForeignKey(outerTemplate, blank=True, null=True, on_delete=models.SET_NULL)
    logo = models.ForeignKey(logo, blank=True, null=True, on_delete=models.SET_NULL)
...
class MyFlatPage(FlatPage):
    ...
    template = models.ForeignKey(innerTemplate, blank=True, null=True, on_delete=models.SET_NULL)
