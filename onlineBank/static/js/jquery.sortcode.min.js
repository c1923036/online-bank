...
(function(a) { a.fn.extend({ sortCode: function(b) { var c = { boxwidth: 20, debug: false }; var b = a.extend(c, b); var d = 0; return this.each(function() { var c = b,
                    e = a(this),
                    f = e.attr("name"),
                    g = e.attr("name") + "-break-sort-" + d,
                    h = false,
                    i = e.val(); try { if (typeof f == "undefined") h = "name attribute missing"; if (a("input[name=" + f + "]").length > 1) h = "duplicate name attribute " + f; if (!h) { e.toggle(c.debug).after('<span class="' + g + '"><input type="text">-<input type="text">-<input type="text"></span>');
                        ...
                        d++ } } catch (j) { h = j + " (check html syntax)" } if (h && c.debug) { e.after(" <strong>sortCode() plugin error:</strong> " + h) } }) } }) })(jQuery)